package com.xia.baseproject.app.delegate;
...
//        this.mActivityLifecycleForRxLifecycle = null;
    ...
    private GlobalConfigModule getGlobalConfigModule(Context context, List<ConfigModule> modules) {
        final GlobalConfigModule.Builder builder = GlobalConfigModule.builder();
    ...
    public AppComponent getAppComponent() {
        Preconditions.checkNotNull(mAppComponent, mApplication.getClass().getName());
