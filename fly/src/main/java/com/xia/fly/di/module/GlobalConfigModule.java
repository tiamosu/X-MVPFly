...
public class GlobalConfigModule {
    ...
    @Singleton
    @Provides
    Cache.Factory<String, Object> provideCacheFactory(final Application application) {
    ...
    ExecutorService provideExecutorService() {
        return mExecutorService != null ? mExecutorService : new ThreadPoolExecutor(
                0, Integer.MAX_VALUE, 60, TimeUnit.SECONDS,
                new SynchronousQueue<Runnable>(), Util.threadFactory("Fly Executor", false)
        );
    }
